...
HD_PWD='C:/Users/TEMP.VT.002/Desktop/lab1/tmp/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_sw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_sw.tcl
